...
class ComparisonFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        context?.let { context ->
            ...
            HttpService.getBodyService(context).getBodyList().enqueue(object:
                Callback<List<BodyEntity>> {
                        ...
                        response.body()?.let { body ->
                            ...
                            one.forEach { body ->
                                ...
                                view.setOnClickListener {
                                    body.id?.let {
                                        mListener.bodyPartClickEventListener(EventType.FRAGMENT_COMPARE, bodyId = it, title = body.name!!)
                                    }
                                }
                            }
    ...
    companion object {
        private const val TAG = "ComparisonFragment"
    }
}